...
)
{
	...
	#
	$ua_priority = $version * 1000000 + $version_u * 1000 + $version_b
	...
	# To put the update-alternatives links in the right place
        $java_home_basename = inline_template('<%= File.basename(@java_home) %>')
	...
	file { "${export_dir}/jce-${export_version}_Orac.jar" :
		...
		target	=> "${java_home}/jre/lib/jce.jar",
	}->
	...
	file { "${export_dir}/jsse-${export_version}_Orac.jar" :
		...
		target	=> "${java_home}/jre/lib/jsse.jar",
	}->
	...
	$alt_java = "\
/usr/sbin/update-alternatives --install /usr/bin/java java ${java_home}/bin/java ${ua_priority} \
 --slave /usr/lib64/jvm/jre jre ${java_home}/jre \
 ...
 --slave /usr/share/man/man1/policytool.1 policytool.1 ${java_home}/man/man1/policytool.1 \
...
"
	...
	$alt_javac = "\
/usr/sbin/update-alternatives --install /usr/bin/javac javac ${java_home}/bin/javac ${ua_priority} \
...
--slave /usr/lib64/jvm/java java_sdk ${java_home} \
...
--slave /usr/share/man/man1/appletviewer.1 appletviewer.1 ${java_home}/man/man1/appletviewer.1 \
--slave /usr/share/man/man1/apt.1 apt.1 ${java_home}/man/man1/apt.1 \
--slave /usr/share/man/man1/extcheck.1 extcheck.1 ${java_home}/man/man1/extcheck.1 \
--slave /usr/share/man/man1/jar.1 jar.1 ${java_home}/man/man1/jar.1 \
--slave /usr/share/man/man1/jarsigner.1 jarsigner.1 ${java_home}/man/man1/jarsigner.1 \
--slave /usr/share/man/man1/javac.1 javac.1 ${java_home}/man/man1/javac.1 \
--slave /usr/share/man/man1/javadoc.1 javadoc.1 ${java_home}/man/man1/javadoc.1 \
--slave /usr/share/man/man1/javah.1 javah.1 ${java_home}/man/man1/javah.1 \
--slave /usr/share/man/man1/javap.1 javap.1 ${java_home}/man/man1/javap.1 \
--slave /usr/share/man/man1/jcmd.1 jcmd.1 ${java_home}/man/man1/jcmd.1 \
--slave /usr/share/man/man1/jconsole.1 jconsole.1 ${java_home}/man/man1/jconsole.1 \
--slave /usr/share/man/man1/jdb.1 jdb.1 ${java_home}/man/man1/jdb.1 \
--slave /usr/share/man/man1/jhat.1 jhat.1 ${java_home}/man/man1/jhat.1 \
--slave /usr/share/man/man1/jinfo.1 jinfo.1 ${java_home}/man/man1/jinfo.1 \
--slave /usr/share/man/man1/jmap.1 jmap.1 ${java_home}/man/man1/jmap.1 \
--slave /usr/share/man/man1/jps.1 jps.1 ${java_home}/man/man1/jps.1 \
--slave /usr/share/man/man1/jrunscript.1 jrunscript.1 ${java_home}/man/man1/jrunscript.1 \
--slave /usr/share/man/man1/jsadebugd.1 jsadebugd.1 ${java_home}/man/man1/jsadebugd.1 \
--slave /usr/share/man/man1/jstack.1 jstack.1 ${java_home}/man/man1/jstack.1 \
--slave /usr/share/man/man1/jstat.1 jstat.1 ${java_home}/man/man1/jstat.1 \
--slave /usr/share/man/man1/jstatd.1 jstatd.1 ${java_home}/man/man1/jstatd.1 \
--slave /usr/share/man/man1/native2ascii.1 native2ascii.1 ${java_home}/man/man1/native2ascii.1 \
...
--slave /usr/share/man/man1/schemagen.1 schemagen.1 ${java_home}/man/man1/schemagen.1 \
--slave /usr/share/man/man1/serialver.1 serialver.1 ${java_home}/man/man1/serialver.1 \
--slave /usr/share/man/man1/unpack200.1 unpack200.1 ${java_home}/man/man1/unpack200.1 \
--slave /usr/share/man/man1/wsgen.1 wsgen.1 ${java_home}/man/man1/wsgen.1 \
--slave /usr/share/man/man1/wsimport.1 wsimport.1 ${java_home}/man/man1/wsimport.1 \
--slave /usr/share/man/man1/xjc.1 xjc.1 ${java_home}/man/man1/xjc.1 \
"
